...
export default function PortfolioLiveClient({ initialCoins, initialBalance }: Props) {
  ...
  // Separate crypto holdings from the USD/USDT cash entry
  ...
  return (
    <>
      ...
      <div>
        ...
        <DataTable data={holdings} columns={columns} params="symbol" />
      </div>
    </>
  );
}
