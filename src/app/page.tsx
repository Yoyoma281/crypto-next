...
import { columns } from "./(main)/coin/coinColumns";
    ...
    <div className="flex flex-col gap-4">
      <div className=" justify-center gap-28">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          Explore all your tables with live sorting, filtering, and detailed
          views.
        </p>

        <DataTable data={res} columns={columns} params="symbol" path="/coin" />
      </div>
    </div>
  );
}
