...
export const KineticComponentPatterns = {
  ...
  cardElevated: "bg-surface-container-low p-10 rounded-xl flex flex-col justify-between border border-outline-variant/10 group hover:border-primary/30 transition-all",
  cardSmall: "bg-surface-container p-8 rounded-xl border border-outline-variant/10 hover:bg-surface-container-high transition-colors",
  
  // Buttons
  buttonPrimary: "gradient-kinetic px-8 py-4 rounded-md font-headline font-bold text-on-primary active:scale-95 transition-transform hover:shadow-lg",
  buttonSecondary: "px-8 py-4 rounded-md border border-outline-variant hover:bg-surface-container transition-colors font-headline font-bold",
  buttonSmall: "px-3 py-1 rounded-md text-xs font-semibold transition-colors",
  
  // Badges
  badge: "inline-flex items-center px-3 py-1 rounded-full bg-secondary-container text-on-secondary-container text-[10px] uppercase tracking-widest font-bold",
  badgePrimary: "inline-flex items-center px-3 py-1 rounded-full bg-primary/20 text-primary text-[10px] uppercase tracking-widest font-bold",
  badgeDanger: "inline-flex items-center px-3 py-1 rounded-full bg-error-container/50 text-error text-[10px] uppercase tracking-widest font-bold",
  
  // Headers
  headerLarge: "font-headline text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1]",
  headerMedium: "font-headline text-3xl md:text-4xl font-bold mb-4",
  headerSmall: "font-headline text-2xl font-bold mb-3",
  
  // Text
  bodyLarge: "font-body text-lg text-on-surface-variant max-w-xl mb-10 leading-relaxed",
  ...
  // Feature cards
  featureLarge: "md:col-span-2 bg-surface-container-low p-10 rounded-xl flex flex-col justify-between min-h-[400px] border border-outline-variant/10 group hover:border-primary/30 transition-all",
  featureSmall: "bg-surface-container p-8 rounded-xl border border-outline-variant/10 hover:bg-surface-container-high transition-colors",
  
  // Step numbers (for onboarding)
  stepNumber: "w-24 h-24 rounded-full flex items-center justify-center border-4 border-background mx-auto mb-8",
  
  // Ticker chips
  tickerChip: "flex items-center gap-4 px-4 py-2 bg-secondary-container/30 rounded-full border border-outline-variant/10",
};
...
export const KineticGradients = {
  ...
  primarySubtle: "linear-gradient(135deg, rgba(78, 222, 163, 0.1) 0%, rgba(0, 147, 101, 0.05) 100%)",
};
