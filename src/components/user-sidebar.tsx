...
import {
  ...
  Trophy, Newspaper, Settings, Star, Bitcoin, User,
} from "lucide-react";
...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { icon: TrendingUp, label: "Exchange",      href: "/coin/BTCUSDT?tab=trade" },
          ...
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-xs text-muted-foreground">Paper Trader</span>
              </div>
            </div>
          ) : (
