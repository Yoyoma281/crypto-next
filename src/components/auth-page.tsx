...
const COINS = [
  ...
  { symbol: "DOGE", color: "#c2a633", bg: "rgba(194,166,51,0.15)",  delay: "0.3s" },
  ...
  return (
    <div className="flex min-h-screen w-full overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(160deg, #070d1a 0%, #0d1a2e 60%, #091420 100%)",
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            <p className="text-white text-xl font-bold leading-snug">
              {isLogin ? <>Practice trading with<br />real market data</> : "Start trading in seconds"}
            </p>
            <p className="text-white/50 text-sm mt-1.5">
              {isLogin ? "Paper trading — 100% risk free" : "No deposit. No credit card. No risk."}
            </p>
          </div>
        </div>
